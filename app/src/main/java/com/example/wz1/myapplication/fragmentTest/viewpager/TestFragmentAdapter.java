...
import com.example.wz1.myapplication.fragmentTest.PagerAdapterTestActivity;
 ...
 */
public class TestFragmentAdapter extends BaseFragment {
    ...
    public static TestFragmentAdapter newInstance(String text) {
        Bundle args = new Bundle();
        args.putString(BTNTEXT_KEY,text);
        TestFragmentAdapter fragment = new TestFragmentAdapter();
