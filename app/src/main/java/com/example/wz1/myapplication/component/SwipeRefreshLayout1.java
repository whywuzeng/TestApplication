//package com.example.wz1.myapplication.component;
//
...
// * by author wz
// * <p>
// * com.example.wz1.myapplication.component
// */
//
//public class SwipeRefreshLayout1 extends ViewGroup implements NestedScrollingParent,
...
//
//    private SwipeRefreshLayout1.OnChildScrollUpCallback mChildScrollUpCallback;
//
//    //CircleView animation动画监听回调
...
//            return i;
//        }
//        else if (i == childCount - 1) { //如果是倒数第一个childview
//            // Draw the selected child last
//            return mCircleViewIndex;
//        }
//        else if (i >= mCircleViewIndex) {//i的索引等于 index ，就让这个孩子移动后一个，让他最后画
...
//    //parent 决定是否需要配合 Child 一起进行处理滑动
//    @Override
...
//    }
//
//    //如果父类滑动了一定距离，你需要重新计算一下父类滑动后剩下给你的滑动距离余量。然后，你自己进行余下的滑动。最后，如果滑动距离还有剩余，你就再问一下，Parent 是否需要在继续滑动你剩下的距离，也就是调用
//    @Override
...
//        if (listener != null) {
//            mTarget.setAnimationListener(listener);
//        }
...
//            setTargetOffsetTopAndBottom(offset); //mCircle距离
...
//         */
//        boolean canChildScrollUp(SwipeRefreshLayout1 parent, @Nullable View child);
//    }
//}
